...
import * as splitViewActions from "../../ducks/splitView"
...
export function SplitViewToggle() {
    const dispatch = useDispatch(),
        visible = useAppSelector(state => state.splitView.visible);

    return (
        <MenuToggle
            value={visible}
            onChange={() => dispatch(splitViewActions.toggleVisibility())}
        >
